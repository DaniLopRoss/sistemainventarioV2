        ...
        def current_ability
         ...
         def configure_permitted_parameters
          devise_parameter_sanitizer.permit(:sign_in) { |u| u.permit(:login, :password) }
             devise_parameter_sanitizer.permit(:sign_up, keys: [:email, :nombre, :id, :apellidouno, :apellidodos, :role, :password_plain]) 
             devise_parameter_sanitizer.permit(:account_update, keys: [:email, :nombre, :id, :apellidouno, :apellidodos, :role,:password_plain])
         end
