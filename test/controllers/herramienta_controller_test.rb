...
class HerramientaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create herramientum" do
    assert_difference("Herramientum.count") do
      post herramienta_url, params: { herramientum: { caracteristicas: @herramientum.caracteristicas, estatus: @herramientum.estatus, existencia: @herramientum.existencia, nombre: @herramientum.nombre } }
    end
  ...
  test "should update herramientum" do
    patch herramientum_url(@herramientum), params: { herramientum: { caracteristicas: @herramientum.caracteristicas, estatus: @herramientum.estatus, existencia: @herramientum.existencia, nombre: @herramientum.nombre } }
